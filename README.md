...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/free-proxy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14829&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/free-proxy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `free-proxy` can be installed with:

```
conda install free-proxy
```

It is possible to list all of the versions of `free-proxy` available on your platform with:
